...
export function createBlobElement(blob: Blob): HTMLDivElement {
  ...
  body.innerHTML = `
    <svg style="width: 100%; height: 100%;" viewBox="0 0 110 74" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path fill-rule="evenodd" clip-rule="evenodd" d="M73 71C63 72 33 72 32 60C32 43 68 34 86 41C78 27 61 28 54 28C40 29 21 38 23 59C24 74 46 74 59 73C59 73 60 73 60 73C61 73 62 73 62 73C64 73 67 73 69 73L73 71Z" fill="black" fill-opacity="0.2"/>
